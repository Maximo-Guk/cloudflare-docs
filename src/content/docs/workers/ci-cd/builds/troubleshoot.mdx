...
- **Failed builds stuck in in-progress:** If your build has failed but the status still shows that the build is "In-progress", you should cancel the build, review your build configuration, then retry the build.
